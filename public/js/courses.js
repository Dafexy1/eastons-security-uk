...
const COURSES = {
  ...
  'door-supervisor': {
    ...
    dates: [
      { label: 'Jan 12 – 20', duration: '9 days', spots: '5 places left', low: true  },
      { label: 'Feb 10 – 18', duration: '9 days', spots: '8 places left', low: false },
      { label: 'Mar 2 – 10',  duration: '9 days', spots: '7 places left', low: false }
    ]
  },
  ...
  'stewarding': {
    ...
    dates: [
      { label: 'Jan 12 – 20', duration: '3 days', spots: '10 places left', low: false },
      { label: 'Feb 10 – 18', duration: '3 days', spots: '8 places left',  low: false },
  ...
  'cctv': {
    ...
    dates: [
      { label: 'Jan 12 – 20', duration: '5 days', spots: '6 places left', low: false },
      { label: 'Feb 10 – 18', duration: '5 days', spots: '8 places left', low: false },
  ...
  'fire-safety': {
    ...
    features: [
      'Fire Risk Awareness', 'Extinguisher Handling', 'Evacuation Procedures',
      'Legislative Compliance', 'Warden Responsibilities', 'Course Certificate'
    ],
    dates: [
  ...
  'cp-refresher': {
    ...
    dates: [
      { label: 'Jan 12 – 20', duration: '3 days', spots: '4 places left', low: true  },
      { label: 'Feb 10 – 18', duration: '3 days', spots: '6 places left', low: false },
  ...
  'so-refresher': {
    ...
    dates: [
      { label: 'Jan 12 – 20', duration: '2 days', spots: '6 places left', low: false },
      { label: 'Feb 10 – 18', duration: '2 days', spots: '4 places left', low: false },
      { label: 'Mar 2 – 10',  duration: '2 days', spots: '3 places left', low: true  }
    ]
  },
  ...
  'ds-refresher': {
    ...
    dates: [
      { label: 'Jan 12 – 20', duration: '2 days', spots: '5 places left', low: false },
      { label: 'Feb 10 – 18', duration: '2 days', spots: '7 places left', low: false },
      { label: 'Mar 2 – 10',  duration: '2 days', spots: '2 places left', low: true  }
    ]
  }
